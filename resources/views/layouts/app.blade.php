  ...
  @if(session('titulo'))
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/met') }}">
                    <img src="/images/logomet.jpg" width="30" height="30" alt="">
                    MET
                </a>
                <a class="navbar-brand" href="{{ url('/oshun') }}">
                    <img src="/images/logooshun2.jpg" width="40" height="40" alt="">
                    OSHUN
                </a>
                <a class="navbar-brand" href="{{ url('/mooc') }}">
                    <img src="/images/logomooc.jpg" width="30" height="30" alt="">
                    MOOC
                </a>
